...
import com.example.administrator.gracecastle.R;
...
public class SharedPreferencesUtil {
	...
	public static boolean putBoolean(Context mContext, String key, boolean nVaule) {
		SharedPreferences preferences = mContext.getSharedPreferences(
				mContext.getString(R.string.my_app_name), 0);
		return preferences.edit().putBoolean(key, nVaule)
				.commit();
	}
	...
	public static String getString(Context mContext, String key) {
		SharedPreferences preferences = mContext.getSharedPreferences(
				mContext.getString(R.string.my_app_name), Context.MODE_PRIVATE);
